...
function alertNotice(data, last_notice) {
    ...
    if (cookie_notice != last_notice) {
        ...
        Swal.fire({
            title: "新公告！",
            html: "<span style=\"color: red; font-weight: bold;\">本站QQ群(当然是首位)：<a href=\"https://jq.qq.com/?_wv=1027&amp;k=G9DJBTKA\">659950593</a>  欢迎加入！！！</span><br>"+"公告时间：" + data[last_notice].time + "<br>公告内容：<span style='color: dodgerblue;font-weight: bold;'>" + noticeMessage + "</span><br>如需查看其他公告请展开首页的公告栏~",
            icon: "success",
...
function changeBoard() {
    ...
    if (window.loaded_notice == 0){
        for (var i in notices) {
            ...
            divObj.innerHTML = "<div style='background-color:rgba(255,255,255,0.8);width:100%;height:15px;line-height:15px'><span style='font-size:12px;margin:8px'>时间：" + notices[i].time + "</span></div><span style='margin:8px'>内容：" + notices[i].content + "</span>";
