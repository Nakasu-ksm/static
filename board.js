...
function alertNotice(data, last_notice) {
    ...
    if (cookie_notice != last_notice) {
        ...
        Swal.fire({
                      title: "新公告！",
                      html: "<span style="color: black; font-weight: bold;">本站QQ群：<a href="https://jq.qq.com/?_wv=1027&amp;k=G9DJBTKA">659950593</a>  欢迎加入！！！</span>公告时间：" + data[last_notice].time + "<br>公告内容：" + data[last_notice].content + "<br>如需查看其他公告请展开首页的公告栏~",
                      icon: "success",
